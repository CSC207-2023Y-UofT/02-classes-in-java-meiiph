...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in two String parameters for arguments.
     * @param s1 the first String argument to the constructor.
     * @param s2 the second String argument to the constructor
     */
